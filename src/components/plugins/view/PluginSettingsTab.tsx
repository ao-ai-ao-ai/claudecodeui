...
const STARTER_PLUGIN_URL = 'https://github.com/siteboon/geel-plugin-starter';
const TERMINAL_PLUGIN_URL = 'https://github.com/siteboon/geel-plugin-terminal';
